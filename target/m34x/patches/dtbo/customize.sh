...
CREATE_CFG() {
    {
        echo "m34x_eur_open_w00_r00.dtbo"
        echo "custom0=0x00000000"
        echo "custom1=0x00000000"
        echo ""
        echo "m34x_eur_open_w00_r01.dtbo"
...
PACK_TO_DTBO() {
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/m34x_eur_open_w00_r00.dtbo" "$TMP_DIR/dtsi.0" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/m34x_eur_open_w00_r01.dtbo" "$TMP_DIR/dtsi.1" &> /dev/null
}
