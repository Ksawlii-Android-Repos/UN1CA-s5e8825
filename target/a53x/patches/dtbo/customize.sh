...
PACK_TO_DTBO() {
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a53x_swa_open_w00_r00.dtbo" "$TMP_DIR/dtsi.0" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a53x_swa_open_w00_r01.dtbo" "$TMP_DIR/dtsi.1" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a53x_swa_open_w00_r02.dtbo" "$TMP_DIR/dtsi.2" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a53x_swa_open_w00_r05.dtbo" "$TMP_DIR/dtsi.3" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a53x_swa_open_w00_r06.dtbo" "$TMP_DIR/dtsi.4" &> /dev/null
}
