...
CREATE_CFG() {
    LOG_STEP_OUT
    {
        echo "a25x_swa_open_w00_r00.dtbo"
        echo "    custom0=0x00000000"
        echo "    custom1=0x00000003"
        echo ""
        echo "a25x_swa_open_w00_r04.dtbo"
        echo "    custom0=0x00000004"
        echo "    custom1=0x00000004"
        echo ""
        echo "a25x_swa_open_w00_r05.dtbo"
...
PACK_TO_DTBO() {
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a25x_swa_open_w00_r00.dtbo" "$TMP_DIR/dtsi.0" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a25x_swa_open_w00_r04.dtbo" "$TMP_DIR/dtsi.1" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a25x_swa_open_w00_r05.dtbo" "$TMP_DIR/dtsi.2" &> /dev/null
}
