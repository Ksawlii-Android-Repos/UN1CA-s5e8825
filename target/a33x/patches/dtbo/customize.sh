...
CREATE_CFG() {
    LOG_STEP_OUT
    {
        ...
        echo ""
        echo "a33x_eur_open_w00_r01.dtbo"
        echo "    custom0=0x00000001"
        echo "    custom1=0x00000001"
        echo ""
        echo "a33x_eur_open_w00_r02.dtbo"
        echo "    custom0=0x00000002"
        echo "    custom1=0x00000002"
        echo ""
        echo "a33x_eur_open_w00_r03.dtbo"
        echo "    custom0=0x00000003"
        echo "    custom1=0x00000003"
        echo ""
        echo "a33x_eur_open_w00_r04.dtbo"
...
PACK_TO_DTBO() {
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a33x_eur_open_w00_r00.dtbo" "$TMP_DIR/dtsi.0" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a33x_eur_open_w00_r01.dtbo" "$TMP_DIR/dtsi.1" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a33x_eur_open_w00_r02.dtbo" "$TMP_DIR/dtsi.2" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a33x_eur_open_w00_r03.dtbo" "$TMP_DIR/dtsi.3" &> /dev/null
    "$TOOLS_DIR/dtc" -I dts -O dtb -o "$TMP_DIR/a33x_eur_open_w00_r04.dtbo" "$TMP_DIR/dtsi.4" &> /dev/null
}
