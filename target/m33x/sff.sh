...
# SEC Floating Feature configuration file for Galaxy M33 5G (m33x)
...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_VENDOR_LIB_INFO=beauty.samsung.v4,face_landmark.arcsoft.v2_1,facial_attribute.samsung.v1,food.samsung.v1,swuwdc.arcsoft.v1,human_tracking_face.arcsoft.v2_1,mfhdr.arcsoft.v1,scene_detection.samsung.v1,llhdr.arcsoft.v1,smart_scan.samsung.v2,single_bokeh.samsung.v2,dual_bokeh.samsung.v1,localtm.samsung.v1_1

# Device specific
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy M33 5G
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_DEFAULT_FONT_SIZE=2
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMM336B
...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_m33x_s5e8825
